...
import { CELL_BODY_LEN } from '@v0idchain/core';
...
export function decodeCell(s: string): CellMsg | null {
  ...
  switch (o.t) {
    case 'CREATE':
      return typeof o.x === 'string' && HEX.test(o.x) ? { t: 'CREATE', c: o.c, x: o.x } : null;
    case 'CREATED':
      return typeof o.y === 'string' && HEX.test(o.y) && typeof o.a === 'string' && HEX.test(o.a)
        ? { t: 'CREATED', c: o.c, y: o.y, a: o.a }
        : null;
    case 'RELAY':
      if ((o.d !== 'f' && o.d !== 'b') || !Number.isInteger(o.n) || o.n < 0) return null;
